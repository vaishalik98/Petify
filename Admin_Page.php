      ...
      <div class="row">
        ...
        <div class="col-md-6 my-6">
          <div class="card">
            ...
            <div class="card-body">
              <div class="dropdown ">
                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">choose where you want to add product
                  <span class="caret"></span></button>
                <ul class="dropdown-menu bg-dark">
                  <li class="bg-light"><a href="Admin_DOG_Food.php">DOG FOOD</a></li>
                  
                  <li class="bg-light"><a href="Admin_CAT_Food.php">CAT FOOD</a></li>
        ...
        <br><div class="col-md-6 my-6">
          <div class="card">
            ...
            <div class="card-body">
              <div class="dropdown ">
                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">choose where u want to delete product
                  <span class="caret"></span></button>
                <ul class="dropdown-menu bg-dark ">
                  <li class="bg-light"><a href="admin_del_product.php">DOG FOOD</a></li>

                  <li class="bg-dark"><a href="Admin_del_cat.php">CAT FOOD</a></li> 
