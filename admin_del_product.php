...
<body class="dog_food">
  ...
  <?php
  include "dbconn.php";
  include "admin_del_dog_product.php";
  ?>
        ...
        <div class="col-md-4 my-5">
          <div class="card">
            <div class="card-footer">
              <p class="lead">Delete Dog Product</p>
            </div>
            <div class="card-body">

              <div class="form-group">
                <input type="text" class="form-control" name="dog_food_name" placeholder="Name of the product">
              </div>

              <div class="form-group">
                <button class="btn btn-primary" type="submit" name="dog_food_add_item">Delete ITEM</button>
              </div>
            </div>
          </div>
        </div>
